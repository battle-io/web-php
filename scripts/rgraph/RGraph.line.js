...
this.context.moveTo(gutter, this.grapharea / 2 + gutter);this.context.lineTo(RGraph.GetWidth(this) - gutter, this.grapharea / 2 + gutter);} else {
...
var yStart = this.Get('chart.xaxispos') == 'center' ? (RGraph.GetHeight(this) / 2) - 3 : RGraph.GetHeight(this) - gutter;var yEnd = this.Get('chart.xaxispos') == 'center' ? yStart + 6 : RGraph.GetHeight(this) - gutter - (x % 60 == 0 ? this.Get('chart.largexticks') * this.Get('chart.tickdirection') : this.Get('chart.smallxticks') * this.Get('chart.tickdirection'));this.context.moveTo(x, yStart);this.context.lineTo(x, yEnd);}
} else if(this.Get('chart.noyaxis') == false){
if(this.Get('chart.yaxispos') == 'left'){
this.context.moveTo(this.Get('chart.gutter'), RGraph.GetHeight(this) - this.Get('chart.gutter'));this.context.lineTo(this.Get('chart.gutter') - this.Get('chart.smallyticks'), RGraph.GetHeight(this) - this.Get('chart.gutter'));} else {
this.context.moveTo(RGraph.GetWidth(this) - this.Get('chart.gutter'), RGraph.GetHeight(this) - this.Get('chart.gutter'));this.context.lineTo(RGraph.GetWidth(this) - this.Get('chart.gutter') + this.Get('chart.smallyticks'), RGraph.GetHeight(this) - this.Get('chart.gutter'));}
}
if(this.Get('chart.noyaxis') == false){
...
if(this.Get('chart.yaxispos') == 'left'){
this.context.moveTo(this.Get('chart.gutter'), RGraph.GetHeight(this) - this.Get('chart.gutter'));this.context.lineTo(this.Get('chart.gutter'), RGraph.GetHeight(this) - this.Get('chart.gutter') + this.Get('chart.smallxticks'));} else {
this.context.moveTo(RGraph.GetWidth(this) - this.Get('chart.gutter'), RGraph.GetHeight(this) - this.Get('chart.gutter'));this.context.lineTo(RGraph.GetWidth(this) - this.Get('chart.gutter'), RGraph.GetHeight(this) - this.Get('chart.gutter') + this.Get('chart.smallxticks'));}
}
this.context.stroke();}
RGraph.Line.prototype.DrawLabels = function ()
{
this.context.strokeStyle = 'black';this.context.fillStyle = this.Get('chart.text.color');this.context.lineWidth = 1;RGraph.NoShadow(this);var font = this.Get('chart.text.font');var gutter = this.Get('chart.gutter');var text_size = this.Get('chart.text.size');var context = this.context;var canvas = this.canvas;if(this.Get('chart.ylabels') && this.Get('chart.ylabels.specific') == null){
...
{
var penUp = false;var yPos = 0;var xPos = 0;this.context.lineWidth = 1;var lineCoords = [];var gutter = this.Get('chart.gutter');var xInterval = (RGraph.GetWidth(this) - (2 * this.Get('chart.hmargin')) - ( (2 * this.gutter)) ) / (lineData.length - 1);for (i=0; i<lineData.length; i++){
yPos = RGraph.GetHeight(this) - ( ( (lineData[i] - (lineData[i] > 0 ?  this.Get('chart.ymin') : (-1 * this.Get('chart.ymin')) ) ) / (this.max - this.min) ) * ((RGraph.GetHeight(this) - (2 * this.gutter)) ));if(this.Get('chart.ylabels.invert')){
